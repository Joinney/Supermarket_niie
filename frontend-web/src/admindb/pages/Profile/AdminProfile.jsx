          ...
          <div className="relative group cursor-pointer mb-4">
            ...
            {profile.avatar_url ? (
              <img
                ...
                onError={(e) => {
                  // Nếu link ảnh bị chết (lỗi 404), tự động chuyển về fallback
            ...
            {/* Fallback chữ cái đầu (Nằm dưới thẻ img, chỉ hiện khi img lỗi hoặc không có) */}
            <div
