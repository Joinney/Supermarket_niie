...
const Loaikhachhang = () => {
  // Dữ liệu giả lập chuẩn theo thiết kế hình ảnh "Loại khách hàng" (image_d032f0.png)
  const MOCK_TYPES = [
    { id: "BT000004", name: "Loại khách hàng 1", description: "abc", createdAt: "28/03/26\nat 8:25 PM", updatedAt: "28/03/26\nat 8:25 PM" },
    { id: "BT000004_1", displayId: "BT000004", name: "Loại khách hàng 1", description: "abc", createdAt: "28/03/26\nat 8:25 PM", updatedAt: "28/03/26\nat 8:25 PM" },
    { id: "BT000004_2", displayId: "BT000004", name: "Loại khách hàng 1", description: "abc", createdAt: "28/03/26\nat 8:25 PM", updatedAt: "28/03/26\nat 8:25 PM" },
    { id: "BT000004_3", displayId: "BT000004", name: "Loại khách hàng 1", description: "abc", createdAt: "28/03/26\nat 8:25 PM", updatedAt: "28/03/26\nat 8:25 PM" },
    { id: "BT000004_4", displayId: "BT000004", name: "Loại khách hàng 1", description: "abc", createdAt: "28/03/26\nat 8:25 PM", updatedAt: "28/03/26\nat 8:25 PM" },
    { id: "BT000004_5", displayId: "BT000004", name: "Loại khách hàng 1", description: "abc", createdAt: "28/03/26\nat 8:25 PM", updatedAt: "28/03/26\nat 8:25 PM" },
    { id: "BT000004_6", displayId: "BT000004", name: "Loại khách hàng 1", description: "abc", createdAt: "28/03/26\nat 8:25 PM", updatedAt: "28/03/26\nat 8:25 PM" },
  ];

  // Theo ảnh thiết kế, toàn bộ các dòng hiện tại đều đang được tick chọn
  const [selectedIds, setSelectedIds] = useState(MOCK_TYPES.map((t) => t.id));

  const handleSelectAll = (e) => {
    if (e.target.checked) {
      setSelectedIds(MOCK_TYPES.map((t) => t.id));
    } else {
      setSelectedIds([]);
    }
  };
  ...
  return (
    <div className="w-full min-h-screen bg-[#fafafa] font-sans text-gray-800 antialiased">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Loại khách hàng</h1>
          <nav className="text-sm text-gray-400 mt-1">
            Dashboard &gt; <span className="text-emerald-600 font-medium">Loại khách hàng</span>
          </nav>
        </div>
              ...
              <tr className="bg-[#f8fafc] border-b border-gray-100 text-[11px] font-bold uppercase tracking-wider text-gray-400">
                <th className="py-4 px-6 w-12 text-center">
                  <input
                    ...
                    checked={selectedIds.length === MOCK_TYPES.length}
                  />
                </th>
                <th className="py-4 px-6">Tên loại</th>
