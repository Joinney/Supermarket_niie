...
// Dữ liệu mẫu (Mock Data) chuẩn hóa khớp chính xác theo hình ảnh image_cf54f9.png
  ...
  return (
    <div className="w-full min-h-screen bg-[#fafafa] font-sans text-gray-800 antialiased p-1">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="bg-[#16a34a] hover:bg-[#15803d] text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors shadow-sm flex items-center gap-1.5">
        ...
        <div className="p-4 bg-white border-t border-gray-50 flex items-center justify-between text-xs text-gray-400 font-medium">
          ...
          <div className="flex items-center gap-2 text-gray-500">
            ...
            <div className="flex items-center gap-1 ml-2">
              <button className="p-1 border border-gray-200 rounded text-gray-300 bg-white cursor-not-allowed" disabled>
                &lt;
              </button>
              <button className="p-1 border border-gray-200 rounded text-gray-600 bg-white hover:bg-gray-50">
                &gt;
              </button>
            </div>
          </div>
