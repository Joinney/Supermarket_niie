  ...
  return (
    <div className="w-full text-gray-800">
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-gray-400 mt-1">Quản lý nhận diện cốt lõi và các thông số vận hành của cửa hàng.</p>
      </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-gray-900">Thông tin cửa hàng & Chi nhánh</h2>
            </div>
            
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Tên cửa hàng</label>
                <input type="text" defaultValue="Demi Mart Chi nhánh chính" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none" />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Mã chi nhánh</label>
                <input type="text" defaultValue="DM-HCM-001" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none" />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Loại hình cửa hàng</label>
              ...
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Email liên hệ</label>
                <input type="email" defaultValue="admin@demimart.vn" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none" />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Số điện thoại</label>
                <input type="text" defaultValue="090 123 4567" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none" />
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Mã số thuế</label>
                <input type="text" defaultValue="0312345678" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none" />
              </div>
              <div className="md:col-span-2">
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Địa chỉ cửa hàng</label>
                <input type="text" defaultValue="123 Đường Thương Mại, Quận 1, TP. Hồ Chí Minh" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none" />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-gray-900">Cấu hình Thuế & Hóa đơn</h2>
            </div>

            <div className="grid grid-cols-1 gap-4 md:grid-cols-3 items-center">
              <div className="md:col-span-1">
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Thuế suất mặc định (%)</label>
                <div className="relative flex items-center">
                  <input type="number" defaultValue="10" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none" />
              ...
              <div className="md:col-span-2 flex items-center justify-between rounded-xl bg-gray-50/70 p-3">
                <div>
                  <p className="text-xs font-semibold text-gray-800">Giá đã bao gồm thuế</p>
                  <p className="text-[11px] text-gray-400 mt-0.5">Hiển thị giá bán cuối cùng đã tính VAT</p>
                </div>
                <button 
                  type="button"
                ...
                >
                  <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${isTaxIncluded ? 'translate-x-5' : 'translate-x-1'}`} />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-gray-900">Bảo mật & Hệ thống</h2>
            </div>

            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
              <div className="md:col-span-1 flex items-center justify-between rounded-xl bg-gray-50/70 p-3">
                <div>
                  <p className="text-xs font-semibold text-gray-880">Xác thực 2 lớp (2FA)</p>
                  <p className="text-[11px] text-gray-400 mt-0.5">Yêu cầu OTP khi đăng nhập</p>
                </div>
                <button 
                  type="button"
                ...
                >
                  <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white transition-transform ${is2FA ? 'translate-x-5' : 'translate-x-1'}`} />
                </button>
              </div>
              <div className="md:col-span-2">
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Thời gian tự động đăng xuất</label>
                <select className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none bg-white">
                  <option>Sau 1 giờ không hoạt động</option>
                </select>
              </div>
              <div className="md:col-span-3">
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Giới hạn IP truy cập</label>
                <input type="text" placeholder="Ví dụ: 192.168.1.1, 10.0.0.5 (Để trống để cho phép tất cả)" className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none placeholder:text-gray-300" />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-gray-900">Tích hợp & API</h2>
            </div>
            <div>
              <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Webhook URL (Đồng bộ kho hàng)</label>
              <div className="flex gap-2">
                <input type="text" defaultValue="https://api.demimart.vn/v1/webhooks/inventory-sync" className="flex-1 rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none text-gray-600" />
                <button type="button" className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 transition">Kiểm tra kết nối</button>
              </div>
              <p className="mt-2 text-[11px] text-gray-400">Dùng để đồng bộ tồn kho thời gian thực với các hệ thống bên ngoài.</p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-gray-900">Cài đặt Vùng & Ngôn ngữ</h2>
            </div>
            
            <div className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Tiền tệ mặc định</label>
                <select className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none bg-white">
                  <option>VND - Việt Nam Đồng (đ)</option>
                </select>
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Múi giờ</label>
                <select className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none bg-white">
                  <option>(GMT+07:00) Bangkok, Hà Nội, Jakarta</option>
                </select>
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Ngôn ngữ hệ thống</label>
                <select className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none bg-white">
                  <option>Tiếng Việt</option>
                </select>
              </div>
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1">Định dạng ngày tháng</label>
                <select className="w-full rounded-lg border border-gray-200 px-3 py-2 text-xs focus:border-emerald-500 focus:outline-none bg-white">
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <input type="text" defaultValue="08:00" className="w-14 rounded-lg border border-gray-200 px-2 py-1 text-center text-xs focus:outline-none focus:border-emerald-500" />
                  <span>-</span>
                  <input type="text" defaultValue="22:00" className="w-14 rounded-lg border border-gray-200 px-2 py-1 text-center text-xs focus:outline-none focus:border-emerald-500" />
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-gray-600">Thứ Bảy</span>
                <div className="flex items-center gap-2">
                  <input type="text" defaultValue="09:00" className="w-14 rounded-lg border border-gray-200 px-2 py-1 text-center text-xs focus:outline-none focus:border-emerald-500" />
                  <span>-</span>
                  <input type="text" defaultValue="23:00" className="w-14 rounded-lg border border-gray-200 px-2 py-1 text-center text-xs focus:outline-none focus:border-emerald-500" />
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="font-semibold text-gray-600">Chủ Nhật</span>
                <div className="flex items-center gap-2">
                  <span className="rounded bg-rose-50 px-2 py-1 text-[10px] font-bold text-rose-500 uppercase tracking-wide">Đóng cửa</span>
              ...
              <button type="button" className="mt-4 w-full rounded-xl border border-dashed border-emerald-500 py-2 text-xs font-semibold text-emerald-600 hover:bg-emerald-50/40 transition">
                + Thêm ngày nghỉ Lễ
              </button>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm">
            <div className="mb-5 flex items-center gap-2">
              ...
              <h2 className="text-sm font-bold text-gray-900">Tài sản thương hiệu</h2>
            </div>

            <div className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Logo cửa hàng</label>
                <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-200 bg-gray-50/50 p-5 text-center cursor-pointer hover:bg-gray-50 transition">
                  ...
                  <p className="text-xs font-bold text-gray-700">Tải lên Logo mới</p>
                  <p className="text-[10px] text-gray-400 mt-1">SVG, PNG, WEBP, JPG (Tối đa 800x800px)</p>
                </div>
              </div>

              <div>
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Màu sắc thương hiệu</label>
                <div className="flex items-center gap-3">
                  <div className="h-7 w-7 rounded-lg bg-[#007A5A] shadow-inner cursor-pointer border border-black/5" title="#007A5A" />
                  <div className="h-7 w-7 rounded-lg bg-white shadow-inner cursor-pointer border border-gray-200" title="#FFFFFF" />
                  <button type="button" className="flex h-7 w-7 items-center justify-center rounded-full border border-dashed border-gray-300 text-gray-400 hover:border-gray-400 hover:text-gray-600 transition text-sm">
                    +
                  </button>
                </div>
              </div>
      ...
      <div className="mt-6 flex items-center justify-between rounded-xl bg-white p-4 border border-gray-100 shadow-sm">
        ...
        <div className="flex gap-3">
          <button type="button" className="rounded-lg px-4 py-2 text-xs font-bold text-gray-500 hover:bg-gray-100 transition">Hủy bỏ</button>
          <button type="button" className="rounded-lg bg-[#007A5A] px-4 py-2 text-xs font-bold text-white hover:bg-[#006349] transition shadow-sm">Cập nhật cài đặt</button>
        </div>
      </div>
    </div>
  );
