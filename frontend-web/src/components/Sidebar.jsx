...
// IMPORT Instance API đã được cấu hình cơ chế tự động nhận diện môi trường
...
export default function Sidebar({ isOpen, onClose }) {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        // Thay thế fetch truyền thống bằng productApi.get()
        const response = await productApi.get('/products/categories');
        const data = response.data; // Axios bọc dữ liệu trả về trong thuộc tính .data
