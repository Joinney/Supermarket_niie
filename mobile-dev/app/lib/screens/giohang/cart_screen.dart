...
import 'package:app/widgets/cart/cart_item_widget.dart'; // Nơi chứa item widget (nếu tách rời) hoặc sử dụng inline bên dưới
...
class _CartScreenState extends State<CartScreen> {
  ...
  // Quản lý các biến thể/sản phẩm được chọn để thanh toán
  final Set<String> _selectedVariantIds = {};
  
  // Quản lý danh sách productId được mở rộng nhóm biến thể
  ...
  // --- 2. FORMAT CÁC MỤC GIỎ HÀNG THỐNG NHẤT ---
              ...
              : RefreshIndicator(
                  ...
                  child: Column(
                    children: [
                      ...
                      // Bottom Navigation Tóm tắt thanh toán
  ...
  // --- WIDGET 3: KHUNG BOTTOM THANH TOÁN ---
